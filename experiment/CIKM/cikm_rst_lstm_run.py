...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - RPredNet')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/cikm_rst_lstm')
parser.add_argument('--r', type=int, default=1)
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_rst_lstm_test/')
