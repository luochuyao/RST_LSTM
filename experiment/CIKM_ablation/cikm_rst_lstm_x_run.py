...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - RST-LSTM-X')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/cikm_rst_lstm_x')

parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_rst_lstm_x_test/')
...
# model
parser.add_argument('--model_name', type=str, default='rst_x')
