...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - RST-LSTM-H')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/cikm_rst_lstm_h')

parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_rst_lstm_h_test/')
...
# model
parser.add_argument('--model_name', type=str, default='rst_h')
